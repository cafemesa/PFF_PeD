...
main (int argc, char **argv)
{
	...
	if(!nh.getParam("/astra_people/sensor_height",sensorheight)){sensorheight = 1.3;}
	...
	if(!nh.getParam("/astra_people/trunk_begin",trunk_begin)){trunk_begin=1.40;}
	if(!nh.getParam("/astra_people/trunk_end",trunk_end)){trunk_end=1.50;}
