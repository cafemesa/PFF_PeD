...
ros::Publisher PeopleCloud_pub,TrunkCloud_pub,LegsCloud_pub;	
...
{ 
    ...
    PeopleCloud_output.header.frame_id = "velodyne";
...
main (int argc, char **argv)
{
	...
	if(!nh.getParam("/velodyne_people/sensor_height",sensorheight)){sensorheight = 0.60;}
